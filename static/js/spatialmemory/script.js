...
function swalHelp(){
    swal({
    title: "Hi",
    text: '<p style="text-align:justify">Cognitive-alz-memory is a game of memory skill. The game creates a series of lights and requires a user to repeat the sequence. If the user succeeds, the series becomes progressively longer and more complex. Once the user fails, the game is over.</p>',
    html: true,
...
function init() {
    ...
    gameName.innerHTML = "Spatial Working Memory";
